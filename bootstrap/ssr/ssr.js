...
var appName = "coder's hot sauce";
createServer((page) => createInertiaApp({
	page,
	render: renderToString,
	title: (title) => `${title} - ${appName}`,
	resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({
		"./Pages/Admin/Dashboard.vue": () => import("./assets/Dashboard-FnIFOMhC.js"),
		"./Pages/Admin/Products/Create.vue": () => import("./assets/Create-1MWoNmQP.js"),
		"./Pages/Admin/Products/Edit.vue": () => import("./assets/Edit-DakqcMaN.js"),
		"./Pages/Admin/Products/Index.vue": () => import("./assets/Index-CmRQVrXZ.js"),
		"./Pages/Admin/Products/Partials/ProductForm.vue": () => import("./assets/ProductForm-yHg6hj2D.js"),
		"./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-A4av_Gbg.js"),
		"./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-931qZJsx.js"),
		"./Pages/Auth/Login.vue": () => import("./assets/Login-DfVmpmaq.js"),
		"./Pages/Auth/Register.vue": () => import("./assets/Register-DBFwDAmV.js"),
		"./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-Cm0R0MzC.js"),
		"./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-IJbDOc5E.js"),
		"./Pages/CheckoutCancel.vue": () => import("./assets/CheckoutCancel-5CV9ud9A.js"),
		"./Pages/CheckoutSuccess.vue": () => import("./assets/CheckoutSuccess-DE7hN15n.js"),
		"./Pages/ClubSilverCancel.vue": () => import("./assets/ClubSilverCancel-k3ZMUh5v.js"),
		"./Pages/ClubSilverSuccess.vue": () => import("./assets/ClubSilverSuccess-C-U26nOW.js"),
		"./Pages/Dashboard.vue": () => import("./assets/Dashboard-B6iXrtF1.js"),
		"./Pages/Profile/Edit.vue": () => import("./assets/Edit-DTRToxtF.js"),
		"./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-CJgF-2JH.js"),
		"./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-C5tJdK29.js"),
		"./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-BLWAXf0p.js"),
		"./Pages/Welcome.vue": () => import("./assets/Welcome-ykbcLJVl.js")
	})),
